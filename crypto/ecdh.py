...
class ECDHNIST256():
    ...
    def generate_private_key(self):
        self.private_key = misc.Math.bytes_to_int(
            bytearray(urandom(self.private_key_size)))

    def generate_public_key(self):
        self.public_key = misc.Math.double_and_add(
            self.G, self.private_key, self.a, self.b, self.modulus)
