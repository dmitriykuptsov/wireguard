...
class IPv4Packet():
    ...
    def set_version(self, version):
        self.buffer[IPV4_VERSION_OFFSET] = self.buffer[IPV4_VERSION_OFFSET] | (
            version << 0x4)
    ...
    def set_identification(self, identification):
        self.buffer[IPV4_IDENTIFICATION_OFFSET] = (
            identification >> 0x8) & 0xFF
    ...
    def set_flags(self, flags):
        self.buffer[IPV4_FLAGS_OFFSET] = self.buffer[IPV4_FLAGS_OFFSET] | (
            flags << 0x5)
    ...
    def set_fragment_offset(self, offset):
        self.buffer[IPV4_FRAGMENT_OFFSET] = self.buffer[IPV4_FRAGMENT_OFFSET] | (
            (offset >> 0x8) & 0x1F)
    ...
    def set_source_address(self, address):
        self.buffer[IPV4_SOURCE_ADDRESS_OFFSET:IPV4_SOURCE_ADDRESS_OFFSET +
                    IPV4_SOURCE_ADDRESS_LENGTH] = address
    ...
    def set_destination_address(self, address):
        self.buffer[IPV4_DESTINATION_ADDRESS_OFFSET:IPV4_DESTINATION_ADDRESS_OFFSET +
                    IPV4_DESTINATION_ADDRESS_LENGTH] = address
